const initPostBlog = () => {
  ...
  const courseCategoryAliases = {
    ...
    "ciencia-datos": "Ciência de Dados",
    javascript: "JavaScript",
    vba: "VBA",
    sql: "SQL",
    "html e css": "HTML e CSS",
    "html y css": "HTML e CSS",
    "html-css": "HTML e CSS",
    ...
    "analisis de datos": "Análise de Dados",
  ...
  const normalizeCategoryName = (value = "") => normalizeLabel(value);
  ...
  const resolveCourseBannerKey = (categoryName) => {
    ...
    const componentBannerAliases = {
      ...
      "ciencia de datos": "ciencia-dados",
      "ciencia-dados": "ciencia-dados",
      "ciencia-datos": "ciencia-dados",
      javascript: "javascript",
      vba: "vba",
      sql: "sql",
      "html e css": "html-css",
      ...
      "analisis de datos": "analise-dados",
      "análisis de datos": "analise-dados",
  ...
  const resolveBannerTrackingConfig = (categoryText = "") => {
    ...
    const trackingAliases = {
      ...
      "excel básico": { curso: "ex", categoria: "treinamento" },
      "excel intermediario": { curso: "ex", categoria: "treinamento" },
      "excel intermediário": { curso: "ex", categoria: "treinamento" },
      "excel avancado": { curso: "ex", categoria: "treinamento" },
      "excel avançado": { curso: "ex", categoria: "treinamento" },
      "excel avanzado": { curso: "ex", categoria: "treinamento" },
      "modelos de planillas": { curso: "ex", categoria: "treinamento" },
      ...
      "sin categoria": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "dicas da hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "consejos de hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "treinamentos corporativos hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "capacitaciones corporativas hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "treinamentos-corporativos-hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      "capacitaciones-corporativas-hashtag": { curso: "comunidade-impressionadora", categoria: "treinamento" },
      ...
      "ciencia de datos": { curso: "cd", categoria: "programacao" },
      "ciencia-dados": { curso: "cd", categoria: "programacao" },
      "ciencia-datos": { curso: "cd", categoria: "programacao" },
      ...
      "html y css": { curso: "htmlcss", categoria: "programacao" },
      ...
      "análise de dados": { curso: "ad", categoria: "treinamento" },
      "analisis de datos": { curso: "ad", categoria: "treinamento" },
      "análisis de datos": { curso: "ad", categoria: "treinamento" },
  ...
  const insertCourseBanner = (attempt = 0) => {
    ...
    if (typeof window.criarBanner === "function") {
      ...
      const categoryLabel =
        courseCategoryAliases[normalizeCategoryName(categoryLink.textContent)] ||
        courseCategoryAliases[normalizeCategoryName(getCategorySlugFromLink().replace(/-/g, " "))];

      if (categoryLabel && courseBannerMap[categoryLabel]) {
        bannerWrapper.innerHTML = courseBannerMap[categoryLabel].banner.replaceAll(
          "Começar agora",
          "Empezar ahora"
        );
      }
