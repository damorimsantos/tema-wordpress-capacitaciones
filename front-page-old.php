<!-- Modelo para a Home Capacitaciones -->

<?php
/*
Template name: Home Capacitaciones Old
*/
?>
...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="/wp-content/themes/hashtag/desenvolvimento_hashtag/assets/sass/css/home-capacitaciones/style.css" />
  ...
  <main>
            <section class="secao hero">
                    ...
                    <div class="hero__textos">
                        <h1>
                            Conviértete en un referente en el mercado laboral
                        </h1>
                        ...
                        <a class="botao-verde url-curso-lancamento--excel"
                        href="https://lp.hashtagcapacitaciones.com/excel/pg-inscripcion?curso=excel&utm_source=site&utm_medium=home&utm_content=home-hero&utm_campaign=capacitacion"
                        target="_blank"
                        >
                        Quiero aprender
                        <svg
                ...
                <div class="container">
                    ...
                    <div class="card card--excel">
                        ...
                        <div class="card__botoes">
                            <div
                                class="card__nome-professor card__nome-professor--excel"
                            >
                                Olivia
                            </div>
                            <a
                                class="card__saber-mais card__saber-mais--excel url-curso-lancamento--excel"
                                href="https://lp.hashtagcapacitaciones.com/excel/pg-inscripcion?curso=excel&utm_source=site&utm_medium=home&utm_content=home-card&utm_campaign=capacitacion"
                                target="_blank"
                                >Más información</a
                            >
                        </div>
            ...
            <section class="secao diferenciais">
                <div class="container">
                    ...
                    <div class="diferenciais__textos">
                        ...
                        <a class="botao-verde url-curso-lancamento--excel"
                            href="https://lp.hashtagcapacitaciones.com/excel/pg-inscripcion?curso=excel&utm_source=site&utm_medium=home&utm_content=home-destaque&utm_campaign=capacitacion"
                            target="_blank"
                        >
                            Quiero aprender
                            <svg
            ...
            <section class="secao largura-total comparacao">
                <div class="comparacao">
                    <div
                        class="comparacao__item comparacao__item--titulo comparacao__item--tradicional comparacao__item--hidem"
                    >
                        <h3>Curso normalito</h3>
                    </div>

                    <div
                        class="comparacao__item comparacao__item--titulo comparacao__item--hidem"
                    >
                        <img
                            loading="lazy"
                            width="27"
                            height="38"
                            style="aspect-ratio: 27/38"
                    ...
                    <div class="comparacao__item ef-slide-100 ef-slide--visivel">
                        <img
                            ...
                            width="21"
                            height="21"
                            style="aspect-ratio: 21/21"
                            src="/wp-content/themes/hashtag/desenvolvimento_hashtag/assets/imgs/Global/x.webp"
                            alt="Icono check"
                        />
                    ...
                    <div
                        class="comparacao__item comparacao__item--titulo ef-slide-100 ef-slide--visivel"
                        aria-hidden="true"
                    >
                        <img
                            loading="lazy"
                    ...
                    <div class="comparacao__item ef-slide-100 ef-slide--visivel">
                        ...
                        />
                        <p>
                            Todo desde cero, con didáctica y lenguaje simple, para que puedas seguir todas las clases independientemente de tu nivel
                        </p>
                    </div>
                    ...
                    <div class="comparacao__item ef-slide-100 ef-slide--visivel">
                        ...
                        />
                        <p>
                            Soporte a todas tus dudas (sobre el contenido de las clases o retos de tu trabajo) por nuestro equipo de expertos de lunes a viernes
                        </p>
                    </div>
            ...
            <div class="container-luz container-luz--1">
                <section class="secao gratuitos">
                    <div class="container">
                        <h2>
                            Contenido
                            <span class="realce-azul"
                                ><b> 100% gratuito </b></span
                            >de Hashtag Capacitaciones
                        </h2>
                        <!-- youtube -->
                        <div
                            class="caixa-youtube gratuitos__item ef-slide ef-slide--visivel"
                        >
                            <div class="caixa-youtube__textos">
                                <div
                                    class="caixa-youtube__logo-seguidores logo-seguidores"
                                >
                                    <svg
                                        width="126"
                                        height="28"
                                    ...
                                    >
                                        <g clip-path="url(#clip0_676_13325)">
                                            ...
                                            />
                                            <path
                                                d="M15.9961 19.9996L26.3875 14.0006L15.9961 8.00146V19.9996Z"
                                                fill="white"
                                            />
                                            <path
                                            ...
                                            />
                                            <path
                                                d="M90.2652 5.16262H86.347V25.9881H82.4848V5.16262H78.5667V1.98859H90.2652V5.16262Z"
                                                fill="white"
                                            />
                                            <path
                                    ...
                                    <div
                                        class="caixa-youtube__seguidores caixa-pilula caixa-pilula--1"
                                    >
                                        +50k suscriptores
                                    </div>
                                </div>
                                ...
                                <div class="caixa-youtube__links">
                                    <a
                                        class="caixa-pilula caixa-pilula--2"
                                        href="https://www.youtube.com/@HashtagCapacitaciones"
                                        target="_blank"
                                        >Canal Hashtag Capacitaciones</a
                                    >
                                </div>
                            </div>
                            <div class="caixa-youtube__caixa-img">
                                <img loading="lazy"
                                    class="caixa-youtube__img"
                        ...
                        <!-- instagram -->
                        <div
                            class="caixa-instagram gratuitos__item ef-slide ef-slide--visivel"
                        >
                            <div class="caixa-instagram__textos">
                                <div
                                    class="caixa-instagram__logo-seguidores logo-seguidores"
                                >
                                    <svg
                                        width="39"
                                        height="39"
                                    ...
                                    <div
                                        class="caixa-instagram__seguidores caixa-pilula caixa-pilula--1"
                                    >
                                        +70K seguidores
                                    </div>
                                </div>
                                ...
                                <div class="caixa-instagram__links">
                                    <a
                                        class="caixa-pilula caixa-pilula--2"
                                        href="https://www.instagram.com/hashtagcapacitaciones/"
                                        target="_blank"
                                        ><svg
                                            width="20"
                                            height="21"
            ...
            <div class="container-luz container-luz--2">
                        ...
                        <div class="empresas__imgs">
                            ...
                            >
                                ...
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    d="M51.7158 12.9538C32.143 30.6683 24.4687 -11.2333 0.105469 4.62505L27.5581 43.7014"
                                    fill="#00939A"
                                />
                                <path
                                    fill-rule="evenodd"
                            ...
                            >
                                ...
                                <path
                                    ...
                                    stroke="white"
                                    stroke-width="1.7716"
                                    mask="url(#path-3-inside-1_676_13628)"
                                />
                            </svg>
                            <!-- petrobras -->
                            <svg
                            ...
                            >
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    d="M44.7086 44.488V0.124756H0.204102V44.488H44.7086Z"
                                    fill="#FBFBFB"
                                />
                                <path
                                    fill-rule="evenodd"
                                ...
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    d="M0.204102 10.905H44.7086V0.124756H0.204102V10.905Z"
                                    fill="#ECB739"
                                />
                                <path
                                    fill-rule="evenodd"
                            ...
                            >
                                <g clip-path="url(#clip0_676_13643)">
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M0.424194 60.435H195.771V0.177612H0.424194V60.435Z"
                                        fill="#F6D43C"
                                    />
                                    <path
                                        fill-rule="evenodd"
                                ...
                                <defs>
                                    <clipPath id="clip0_676_13643">
                                        <rect
                                            ...
                                            height="60.3331"
                                            fill="white"
                                            transform="translate(0.398926 0.139893)"
                                        />
                                    </clipPath>
                                </defs>
                            </svg>
                ...
                <section class="secao ajudar">
                    <div class="container">
                        <img loading="lazy"
                            class="ajudar__img ef-slide ef-slide--visivel"
                    ...
                    <div class="container ajudar__parte ajudar__parte--1">
                        <h2>
                            ...
                            >
                                <rect
                                    width="43.3948"
                                    height="61.0239"
                                    fill="url(#pattern0_676_16588)"
                                />
                                <defs>
                                    <pattern
                                        id="pattern0_676_16588"
                                        patternContentUnits="objectBoundingBox"
                                        width="1"
                                        height="1"
                                    >
                                        <use
                                            xlink:href="#image0_676_16588"
                                            transform="matrix(0.00446428 0 0 0.0031746 -0.575893 -1.06667)"
                                        />
                                    </pattern>
                                    <image
                                        id="image0_676_16588"
                            ...
                            ><b>¿Cómo Hashtag te puede ayudar?</b>
                        </h2>
                        <div class="ajudar__grid">
                            <div class="ajudar__item">
                                ...
                                />
                                <span
                                    >¿Quieres convertirte en un referente en la empresa donde trabajas?</span
                                >
                            </div>
                            <div class="ajudar__item">
                                <img loading="lazy"
                                ...
                                />
                                <span
                                    >¿Quieres destacar en un proceso de selección?</span
                                >
                            </div>
                            <div class="ajudar__item">
                                <img loading="lazy"
                            ...
                            <div class="ajudar__item">
                                ...
                                />
                                <span
                                    >¿Quieres aplicar Excel a tu propio negocio?</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ajudar__parte ajudar__parte--3">
                        ...
                        <div class="ajudar__cursos-paragrafos">
                            ...
                            <div class="ajudar__paragrafos">
                                <p>
                                    Hashtag Capacitaciones fue creada por Hashtag Treinamentos, una empresa brasileña que comenzó en 2016 y, actualmente, es una de las empresas más fuertes en capacitación profesional por medio de cursos online.
                                </p>
                                <p>
                                    Tenemos más de 140 mil alumnos capacitados.
                                </p>
                                <p>
                                    En nuestro canal de YouTube Hashtag Treinamentos, tenemos más de 1,5 millón de suscriptores. En nuestro canal Hashtag Capacitaciones, creado hace poco meses, tenemos ya más de 50 mil suscriptores. En ambos podrás ver muchas reseñas positivas, tanto de nuestros seguidores como de nuestros alumnos.
                                </p>
                                <p>
                                    Todos nuestros programas son súper didácticos, con una satisfacción superior al 98,3% y llevan a cualquiera desde lo básico hasta el nivel impresionante, que está por encima del avanzado.
                                </p>
                                <p>
                                    Además de nuestros cursos online, Hashtag ya realizó capacitaciones in-company en grandes empresas como LinkedIn, L’Oréal, Icatu Seguros, Kempetro y Niely.
                                </p>
                            </div>
                        </div>
                       
                            <a class="botao-verde url-curso-lancamento--excel"
                                href="https://lp.hashtagcapacitaciones.com/excel/pg-inscripcion?curso=excel&utm_source=site&utm_medium=home&utm_content=home-ajudar&utm_campaign=capacitacion"
                                target="_blank"
                            >
